    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png" alt="app-logo"></img>
            </div>
    ...
    return (
        <div className="res-card" style={{backgroundColor: "#f0f0f0"}}>
            <img
                className="res-logo"
                alt="biryani"
                // src="https://axwwgrkdco.cloudimg.io/v7/lefooding.com/medias/2024/02/DOUBLE_LS-%C2%AEMickael-A.-Bandassak4-1.jpg?width=800&optipress=3" />
            ...
            />
            // {/* <h3>Meghna Foods</h3>
            // <h4>Biryani, Indian Foods, Italian</h4>
            // <h4>4.4 stars</h4>
            // <h4>38 minutes</h4> */}
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
